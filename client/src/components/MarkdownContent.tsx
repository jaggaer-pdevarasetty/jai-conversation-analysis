...
// NOTE: we intentionally do NOT regex-strip HTML tags here. Every branch below emits React
// text nodes / known elements, so any raw HTML in the source is escaped and shown literally
// (safe). Regex tag-stripping was both an incomplete sanitizer (a false sense of security) and
// the cause of real content being deleted (e.g. "<tenant-id>", "x < 5 and y > 3") — so it's gone.
